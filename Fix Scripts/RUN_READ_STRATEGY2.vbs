...
scpCmd = "cmd /c scp -i " & KEY & " -o StrictHostKeyChecking=no " & _
         """C:\Users\Matheus\Desktop\Site MicroERP\read_strategy2.sh"" " & _
         SRV & ":/home/ubuntu/read_strategy2.sh 2>&1"
...
sshCmd = "cmd /c ssh -i " & KEY & " -o StrictHostKeyChecking=no " & _
         SRV & " ""bash /home/ubuntu/read_strategy2.sh"" 2>&1"
...
Set oFile = oFSO.CreateTextFile("C:\Users\Matheus\Desktop\Site MicroERP\strategy2_output.txt", True)
oFile.Write sOut
oFile.Close

MsgBox "Salvo em strategy2_output.txt", 64, "Done"
